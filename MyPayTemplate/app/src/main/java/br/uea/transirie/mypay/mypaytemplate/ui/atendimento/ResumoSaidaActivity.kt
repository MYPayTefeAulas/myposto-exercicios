...
class ResumoSaidaActivity : AppCompatActivity() {
    ...
    private val adapter = ResumoSaidaAdapter(context, mutableListOf())
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        menuInflater.inflate(R.menu.menu_imprimir, menu)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        if(item.itemId==R.id.menuImprimir_btnImprimir){
            printReceipt()
        }
