...
import br.uea.transirie.mypay.mypaytemplate.databinding.ActivityAdicionarColaboradorBinding
...
class AdicionarColaboradorActivity : AppCompatActivity() {
    ...
    private fun checkAndAdvance(){
        ...
        val cnpjEstabelecimento = userPrefs.getString(getString(R.string.PREF_USER_ESTABELECIMENTO_CNPJ), "").toString()
