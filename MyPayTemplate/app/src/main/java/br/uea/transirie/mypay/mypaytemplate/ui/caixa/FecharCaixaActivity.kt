...
class FecharCaixaActivity : AppCompatActivity() {
    ...
    private fun listeners(){
        ...
        binding.button.setOnClickListener {
            ...
            builder.setPositiveButton("FECHAR"){dialog,_->
                ...
                sharedEditor.putString(estabelecimentoCNPJ, Gson().toJson(CaixaStatus(status = true, data = LocalDate.now())))
    ...
    private fun preencherTela(){
        ...
        val statusAbrirCaixa= Gson().fromJson(pref.getString(estabelecimentoCNPJ, Gson().toJson(AbrirCaixaStatus(status = false, data = LocalDate.now(), valor =0f))),
