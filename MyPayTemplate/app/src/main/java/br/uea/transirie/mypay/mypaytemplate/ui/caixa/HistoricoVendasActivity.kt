...
class HistoricoVendasActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        estabelecimentoCNPJ = AppPreferences.getCNPJLogado(this)
    ...
    private fun calcularHistorico(){
        ...
        doAsync {
            ...
            when(tabSelecionada){
                1 ->{
                    caixaViewModel.getDespesasDia(LocalDate.parse("${autoCompleteTextviewPrimeiroHistoricoVendas.text}/$dataMes/${autoCompleteTextviewTerceiroHistoricoVendas.text}", DateTimeFormatter.ofPattern("dd/MM/yyyy")),estabelecimentoCNPJ)
                    caixaViewModel.getRecebidosDia(LocalDate.parse("${autoCompleteTextviewPrimeiroHistoricoVendas.text}/$dataMes/${autoCompleteTextviewTerceiroHistoricoVendas.text}", DateTimeFormatter.ofPattern("dd/MM/yyyy")),estabelecimentoCNPJ)
                    uiThread {
                ...
                2 ->{
                    caixaViewModel.getDespesasMes(LocalDate.parse("01/$dataMes/${autoCompleteTextviewSegundoHistoricoVendas.text}", DateTimeFormatter.ofPattern("dd/MM/yyyy")),estabelecimentoCNPJ)
                    caixaViewModel.getRecebidosMes(LocalDate.parse("01/$dataMes/${autoCompleteTextviewSegundoHistoricoVendas.text}", DateTimeFormatter.ofPattern("dd/MM/yyyy")),estabelecimentoCNPJ)
                    uiThread {
                        txtDataConsulta.text = "$dataMes/${autoCompleteTextviewSegundoHistoricoVendas.text}"
                    }
                }
                3 ->{
                    caixaViewModel.getDespesasAno(LocalDate.parse("01/01/${autoCompleteTextviewPrimeiroHistoricoVendas.text}", DateTimeFormatter.ofPattern("dd/MM/yyyy")),estabelecimentoCNPJ)
                    caixaViewModel.getRecebidosAno(LocalDate.parse("01/01/${autoCompleteTextviewPrimeiroHistoricoVendas.text}", DateTimeFormatter.ofPattern("dd/MM/yyyy")),estabelecimentoCNPJ)
                    uiThread {
