...
class HistoricoVendasActivity : AppCompatActivity() {
    ...
    private fun calcularHistorico(){
        ...
        doAsync {
            ...
            when(tabSelecionada){
                1 ->{
                    caixaViewModel.getDespesasDia(LocalDate.parse("${autoCompleteTextviewPrimeiroHistoricoVendas.text}/$dataMes/${autoCompleteTextviewTerceiroHistoricoVendas.text}", DateTimeFormatter.ofPattern("dd/MM/yyyy")),usuario)
                    caixaViewModel.getRecebidosDia(LocalDate.parse("${autoCompleteTextviewPrimeiroHistoricoVendas.text}/$dataMes/${autoCompleteTextviewTerceiroHistoricoVendas.text}", DateTimeFormatter.ofPattern("dd/MM/yyyy")),usuario)
                    uiThread {
                ...
                2 ->{
                    caixaViewModel.getDespesasMes(LocalDate.parse("01/$dataMes/${autoCompleteTextviewSegundoHistoricoVendas.text}", DateTimeFormatter.ofPattern("dd/MM/yyyy")),usuario)
                    caixaViewModel.getRecebidosMes(LocalDate.parse("01/$dataMes/${autoCompleteTextviewSegundoHistoricoVendas.text}", DateTimeFormatter.ofPattern("dd/MM/yyyy")),usuario)
                    uiThread {
                        txtDataConsulta.text = "$dataMes/${autoCompleteTextviewSegundoHistoricoVendas.text}"
                    }
                }
                3 ->{
                    caixaViewModel.getDespesasAno(LocalDate.parse("01/01/${autoCompleteTextviewPrimeiroHistoricoVendas.text}", DateTimeFormatter.ofPattern("dd/MM/yyyy")),usuario)
                    caixaViewModel.getRecebidosAno(LocalDate.parse("01/01/${autoCompleteTextviewPrimeiroHistoricoVendas.text}", DateTimeFormatter.ofPattern("dd/MM/yyyy")),usuario)
                    uiThread {
            ...
            uiThread {
                if (caixaViewModel.getPagamentoCartao() != 0.0 ||
                    caixaViewModel.getPagamentoCartao() != 0.0 ||
