...
import br.uea.transirie.mypay.mypaytemplate.databinding.ActivityLoginBinding
...
import br.uea.transirie.mypay.mypaytemplate.ui.recuperar_pin.EnviarEmailActivity
import br.uea.transirie.mypay.mypaytemplate.utils.getNewColor
import br.uea.transirie.mypay.mypaytemplate.utils.pinHasErrors
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun validarLoginLocal(){
        val isPinOkay = !pinHasErrors(binding.loginTxtPin, myContext)
    ...
    private fun makeLogin(usuario: Usuario) {
        ...
        editor.putString(getString(R.string.PREF_USER_ESTABELECIMENTO_CNPJ), usuario.estabelecimentoCNPJ)
        ...
        sharedEdit.putString(getString(R.string.PREF_USER_ESTABELECIMENTO_CNPJ), usuario.estabelecimentoCNPJ)
        sharedEdit.apply()
