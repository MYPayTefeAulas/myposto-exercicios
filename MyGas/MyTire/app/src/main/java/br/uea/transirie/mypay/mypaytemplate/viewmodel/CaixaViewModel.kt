...
class CaixaViewModel(appDatabase: AppDatabase) {
    ...
    fun getRecebidosAno(dataHoje: LocalDate, usuario:String){
        pagamentoDinheiro = 0.0
        pagamentoCartao = 0.0
        pagamentoCredito = 0.0
        pagamentoDebito = 0.0
        totalClientes = 0
        val lista = pagamentoList.filter { it.usuario == usuario }
    ...
    fun getRecebidosDia(dataHoje: LocalDate, usuario:String){
        pagamentoDinheiro = 0.0
        pagamentoCartao = 0.0
        pagamentoCredito = 0.0
        pagamentoDebito = 0.0
    ...
    fun getRecebidosMes(dataHoje: LocalDate, usuario:String){
        pagamentoDinheiro = 0.0
        pagamentoCartao = 0.0
        pagamentoCredito = 0.0
        pagamentoDebito = 0.0
    ...
    fun getDespesasAno(dataHoje: LocalDate, usuario:String){
        despesaDinheiro = 0.0
        despesaCartao = 0.0
        despesaCredito = 0.0
        despesaDebito = 0.0
        val lista = despesaList.filter { it.usuario == usuario }
    ...
    fun getDespesasMes(dataHoje: LocalDate, usuario:String){
        despesaDinheiro = 0.0
        despesaCartao = 0.0
        despesaCredito = 0.0
        despesaDebito = 0.0
    ...
    fun getDespesasDia(dataHoje: LocalDate, usuario:String){
        despesaDinheiro = 0.0
        despesaCartao = 0.0
        despesaCredito = 0.0
        despesaDebito = 0.0
